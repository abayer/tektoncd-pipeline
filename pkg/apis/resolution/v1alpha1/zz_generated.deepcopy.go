...
func (in *ResolutionParam) DeepCopyInto(out *ResolutionParam) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResolutionParam.
func (in *ResolutionParam) DeepCopy() *ResolutionParam {
	if in == nil {
		return nil
	}
	out := new(ResolutionParam)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ResolutionRequestSpec) DeepCopyInto(out *ResolutionRequestSpec) {
	*out = *in
	if in.Params != nil {
		...
		*out = make([]ResolutionParam, len(*in))
		copy(*out, *in)
	}
	return
}
