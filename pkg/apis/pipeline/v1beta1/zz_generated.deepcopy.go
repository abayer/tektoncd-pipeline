...
func (in *ChildStatusReference) DeepCopyInto(out *ChildStatusReference) {
	*out = *in
	...
	if in.ConditionChecks != nil {
		...
		*out = make([]*PipelineRunChildConditionCheckStatus, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(PipelineRunChildConditionCheckStatus)
				(*in).DeepCopyInto(*out)
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EmbeddedPipeline) DeepCopyInto(out *EmbeddedPipeline) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EmbeddedPipeline.
func (in *EmbeddedPipeline) DeepCopy() *EmbeddedPipeline {
	if in == nil {
		return nil
	}
	out := new(EmbeddedPipeline)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PipelinePipelineRunSpec) DeepCopyInto(out *PipelinePipelineRunSpec) {
	*out = *in
	if in.Timeouts != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PipelinePipelineRunSpec.
func (in *PipelinePipelineRunSpec) DeepCopy() *PipelinePipelineRunSpec {
	if in == nil {
		return nil
	}
	out := new(PipelinePipelineRunSpec)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PipelineRunChildConditionCheckStatus) DeepCopyInto(out *PipelineRunChildConditionCheckStatus) {
	*out = *in
	in.PipelineRunConditionCheckStatus.DeepCopyInto(&out.PipelineRunConditionCheckStatus)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PipelineRunChildConditionCheckStatus.
func (in *PipelineRunChildConditionCheckStatus) DeepCopy() *PipelineRunChildConditionCheckStatus {
	if in == nil {
		return nil
	}
	out := new(PipelineRunChildConditionCheckStatus)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PipelineRunPipelineRunStatus) DeepCopyInto(out *PipelineRunPipelineRunStatus) {
	*out = *in
	if in.Status != nil {
		in, out := &in.Status, &out.Status
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PipelineRunPipelineRunStatus.
func (in *PipelineRunPipelineRunStatus) DeepCopy() *PipelineRunPipelineRunStatus {
	if in == nil {
		return nil
	}
	out := new(PipelineRunPipelineRunStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PipelineRunSpec) DeepCopyInto(out *PipelineRunSpec) {
	*out = *in
	...
	if in.PipelineRunSpecs != nil {
		in, out := &in.PipelineRunSpecs, &out.PipelineRunSpecs
		*out = make([]PipelinePipelineRunSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
