...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/tektoncd/pipeline/pkg/apis/pipeline/v1beta1.EmbeddedPipeline":                     schema_pkg_apis_pipeline_v1beta1_EmbeddedPipeline(ref),
		...
		"github.com/tektoncd/pipeline/pkg/apis/pipeline/v1beta1.PipelinePipelineRunSpec":              schema_pkg_apis_pipeline_v1beta1_PipelinePipelineRunSpec(ref),
		...
		"github.com/tektoncd/pipeline/pkg/apis/pipeline/v1beta1.PipelineRunPipelineRunStatus":         schema_pkg_apis_pipeline_v1beta1_PipelineRunPipelineRunStatus(ref),
...
func schema_pkg_apis_pipeline_v1beta1_EmbeddedPipeline(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "EmbeddedPipeline is used to define a Pipeline within a Pipeline's PipelineTasks.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"description": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/tektoncd/pipeline/pkg/apis/pipeline/v1beta1.ParamSpec", "github.com/tektoncd/pipeline/pkg/apis/pipeline/v1beta1.PipelineDeclaredResource", "github.com/tektoncd/pipeline/pkg/apis/pipeline/v1beta1.PipelineResult", "github.com/tektoncd/pipeline/pkg/apis/pipeline/v1beta1.PipelineTask", "github.com/tektoncd/pipeline/pkg/apis/pipeline/v1beta1.PipelineTaskMetadata", "github.com/tektoncd/pipeline/pkg/apis/pipeline/v1beta1.PipelineWorkspaceDeclaration"},
	}
}
...
func schema_pkg_apis_pipeline_v1beta1_PipelinePipelineRunSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PipelinePipelineRunSpec can be used to configure specific specs for a concrete Pipeline",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"pipelineTaskName": {
						SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_pipeline_v1beta1_PipelineRunPipelineRunStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PipelineRunPipelineRunStatus contains the name of the PipelineTask for this PipelineRun and the PipelineRun's Status",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"pipelineTaskName": {
						SchemaProps: spec.SchemaProps{
					...
					"status": {
						SchemaProps: spec.SchemaProps{
							Description: "Status is the PipelineRunStatus for the corresponding PipelineRun",
							Ref:         ref("github.com/tektoncd/pipeline/pkg/apis/pipeline/v1beta1.PipelineRunStatus"),
						},
					},
					"whenExpressions": {
		...
		Dependencies: []string{
			"github.com/tektoncd/pipeline/pkg/apis/pipeline/v1beta1.PipelineRunStatus", "github.com/tektoncd/pipeline/pkg/apis/pipeline/v1beta1.WhenExpression"},
	}
}
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"taskRunSpecs": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "TaskRunSpecs holds a set of runtime specs for TaskRuns",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"pipelineRunSpecs": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "PipelineRunSpecs holds a set of runtime specs for PipelineRuns",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/tektoncd/pipeline/pkg/apis/pipeline/v1beta1.PipelinePipelineRunSpec"),
									},
								},
							},
						},
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"pipelineRef": {
						SchemaProps: spec.SchemaProps{
							Description: "PipelineRef is a reference to another, nested pipeline.",
							Ref:         ref("github.com/tektoncd/pipeline/pkg/apis/pipeline/v1beta1.PipelineRef"),
						},
					},
					"pipelineSpec": {
						SchemaProps: spec.SchemaProps{
							Description: "PipelineSpec is a specification of another, nested pipeline.",
							Ref:         ref("github.com/tektoncd/pipeline/pkg/apis/pipeline/v1beta1.EmbeddedPipeline"),
						},
					},
					"conditions": {
						VendorExtensible: spec.VendorExtensible{
