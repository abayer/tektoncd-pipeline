...
func TestPodBuild(t *testing.T) {
	...
	for _, c := range []struct {
		...
		want: &corev1.PodSpec{
			...
			InitContainers: []corev1.Container{tektonDirInit(images.EntrypointImage, []v1beta1.Step{{Name: "name"}})},
		...
		want: &corev1.PodSpec{
			RestartPolicy:  corev1.RestartPolicyNever,
			InitContainers: []corev1.Container{tektonDirInit(images.EntrypointImage, []v1beta1.Step{{Name: "a-very-very-long-character-step-name-to-trigger-max-len----and-invalid-characters"}})},
			Containers: []corev1.Container{{
		...
		want: &corev1.PodSpec{
			RestartPolicy:  corev1.RestartPolicyNever,
			InitContainers: []corev1.Container{tektonDirInit(images.EntrypointImage, []v1beta1.Step{{Name: "ends-with-invalid-%%__$$"}})},
			Containers: []corev1.Container{{
		...
		want: &corev1.PodSpec{
			...
			InitContainers: []corev1.Container{
				tektonDirInit(images.EntrypointImage, []v1beta1.Step{{Name: "name"}}),
				{
		...
		want: &corev1.PodSpec{
			RestartPolicy:  corev1.RestartPolicyNever,
			InitContainers: []corev1.Container{tektonDirInit(images.EntrypointImage, []v1beta1.Step{{Name: "primary-name"}})},
			Containers: []corev1.Container{{
		...
		want: &corev1.PodSpec{
			RestartPolicy: corev1.RestartPolicyNever,
			InitContainers: []corev1.Container{
				tektonDirInit(images.EntrypointImage, []v1beta1.Step{{Name: "primary-name"}}),
				{
					Name:         "place-scripts",
					Image:        "busybox",
					Command:      []string{"sh"},
...
`},
		...
		want: &corev1.PodSpec{
			RestartPolicy: corev1.RestartPolicyNever,
			InitContainers: []corev1.Container{tektonDirInit(images.EntrypointImage, []v1beta1.Step{
				{Name: "unnamed-0"},
				{Name: "unnamed-1"},
			})},
			Containers: []corev1.Container{{
...
`},
		...
		want: &corev1.PodSpec{
			RestartPolicy: corev1.RestartPolicyNever,
			InitContainers: []corev1.Container{tektonDirInit(images.EntrypointImage, []v1beta1.Step{{Name: "one"}}),
				{
					Name:    "place-scripts",
					Image:   images.ShellImage,
					Command: []string{"sh"},
...
`},
		...
		want: &corev1.PodSpec{
			RestartPolicy:  corev1.RestartPolicyNever,
			InitContainers: []corev1.Container{tektonDirInit(images.EntrypointImage, []v1beta1.Step{{Name: "schedule-me"}})},
			SchedulerName:  "there-scheduler",
			Volumes: append(implicitVolumes, binVolume, runVolume(0), downwardVolume, corev1.Volume{
				Name:         "tekton-creds-init-home-0",
				VolumeSource: corev1.VolumeSource{EmptyDir: &corev1.EmptyDirVolumeSource{Medium: corev1.StorageMediumMemory}},
		...
		want: &corev1.PodSpec{
			RestartPolicy:  corev1.RestartPolicyNever,
			InitContainers: []corev1.Container{tektonDirInit(images.EntrypointImage, []v1beta1.Step{{Name: "image-pull"}})},
			Volumes: append(implicitVolumes, binVolume, runVolume(0), downwardVolume, corev1.Volume{
				Name:         "tekton-creds-init-home-0",
				VolumeSource: corev1.VolumeSource{EmptyDir: &corev1.EmptyDirVolumeSource{Medium: corev1.StorageMediumMemory}},
			}),
		...
		}},
		{
			...
			want: &corev1.PodSpec{
				RestartPolicy:  corev1.RestartPolicyNever,
				InitContainers: []corev1.Container{tektonDirInit(images.EntrypointImage, []v1beta1.Step{{Name: "host-aliases"}})},
				Volumes: append(implicitVolumes, binVolume, runVolume(0), downwardVolume, corev1.Volume{
					Name:         "tekton-creds-init-home-0",
					VolumeSource: corev1.VolumeSource{EmptyDir: &corev1.EmptyDirVolumeSource{Medium: corev1.StorageMediumMemory}},
				}),
			...
			want: &corev1.PodSpec{
				RestartPolicy:  corev1.RestartPolicyNever,
				InitContainers: []corev1.Container{tektonDirInit(images.EntrypointImage, []v1beta1.Step{{Name: "use-my-hostNetwork"}})},
				HostNetwork:    true,
				Volumes: append(implicitVolumes, binVolume, runVolume(0), downwardVolume, corev1.Volume{
					Name:         "tekton-creds-init-home-0",
					VolumeSource: corev1.VolumeSource{EmptyDir: &corev1.EmptyDirVolumeSource{Medium: corev1.StorageMediumMemory}},
