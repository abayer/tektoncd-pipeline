...
import "github.com/tektoncd/pipeline/pkg/apis/resolution/v1alpha1"
...
func (req *BasicRequest) Params() []v1alpha1.ResolutionParam {
	var params []v1alpha1.ResolutionParam
	for k, v := range req.params {
		params = append(params, v1alpha1.ResolutionParam{
			Name:  k,
			Value: v,
		})
	}
